...
enum WorldBoolConfigs
{
    ...
    // User Pimper
    CONFIG_USER_PIMPER_PRESENTS_ALLOWED,
...
enum WorldIntConfigs
{
    ...
    // User Pimper
    CONFIG_USER_PIMPER_CURRENCY,
    CONFIG_USER_PIMPER_CURRENCY_ITEM,
    CONFIG_USER_PIMPER_COSTS_MINIPETS,
    CONFIG_USER_PIMPER_COSTS_REPUTATION,
    CONFIG_USER_PIMPER_COSTS_PROFFESSION,
    CONFIG_USER_PIMPER_COSTS_RECIPES,
    CONFIG_USER_PIMPER_COSTS_MAXSKILL,
